...
// #cgo CPPFLAGS: -DSQLCIPHER_CRYPTO_CUSTOM=sqlcipher_go_setup
...
// #cgo CPPFLAGS: -DSQLITE_HAS_CODEC
// #cgo CPPFLAGS: -DSQLITE_OMIT_LOAD_EXTENSION
// #cgo CPPFLAGS: -DSQLITE_TEMP_STORE=2
// #cgo CPPFLAGS: -DSQLITE_THREADSAFE=1
