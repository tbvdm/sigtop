...
CPPFLAGS+=	-DSQLITE_HAS_CODEC -DSQLITE_OMIT_LOAD_EXTENSION \
		-DSQLITE_OS_UNIX=1 -DSQLITE_TEMP_STORE=2 -DSQLITE_THREADSAFE=0
CFLAGS+=	${PKGS_CFLAGS}
...
OBJS=		cmd-check.o cmd-export-attachments.o cmd-export-database.o \
		cmd-export-messages.o mime.o sbk.o sigtop.o sqlite3.o utf.o \
		${COMPAT_OBJS}
